...
#Para empezar, limpiaré la tabla. 
...
#A continuación realizaré un mapa que permita observar en qué partes del mundo y paises hubo más casos a lo largo del 2020. 
...
#Por Ãºltimo, veremos cual fue el mes con mayores muertes en Argentina. 
...
#Es posible observar que en Argentina el es de Diciembre 2020 fue el que tuvo el mayor Ã­ndice de contagios. 

#A modo de conclusiÃ³n final, compararemos la cantidad de muertes por mes de Estados Unidos y Argentina. 
...
#A modo de cierre, es posible observar que en ambos paises aumentaron las muertes en 2020 hacia fin de aÃ±o, es decir en noviembre y diciembre. 
